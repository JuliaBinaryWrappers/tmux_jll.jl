...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tmux_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("558ad2b7-f92e-50c4-8d35-b0432ac1efd4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tmux", artifacts_toml) for e in artifacts["tmux"]]
...
if best_platform === nothing
    @debug("Unable to load tmux; unsupported platform $(triplet(platform_key_abi()))")
else
